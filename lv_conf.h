...
#define LV_VDB_SIZE         ((LV_HOR_RES * LV_VER_RES) / 10)  /*Size of VDB in pixel count (1/10 screen size is good for first)*/
...
#define USE_LV_FONT_DEJAVU_10_LATIN_SUP    1
#define USE_LV_FONT_DEJAVU_10_CYRILLIC     1
...
#define USE_LV_FONT_DEJAVU_30_LATIN_SUP    1
#define USE_LV_FONT_DEJAVU_30_CYRILLIC     1
