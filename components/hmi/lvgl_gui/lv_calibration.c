...
static void CalibrationCrossDraw(const lv_point_t *pp)
{
    ...
    pct[0].x = pp->x - CALIBRATION_CROSS_RADIUS;
    pct[0].y = pp->y;
    pct[1].x = pp->x - CALIBRATION_CROSS_INNERGAP;
    pct[1].y = pp->y;
    line[0] = lv_line_create(lv_scr_act(), NULL);
    lv_line_set_style(line[0], &style1);
    lv_obj_set_pos(line[0], 0, 0);
    lv_line_set_points(line[0], &pct[0], 2);

    pct[2].x = pp->x + CALIBRATION_CROSS_INNERGAP;
    pct[2].y = pp->y;
    pct[3].x = pp->x + CALIBRATION_CROSS_RADIUS;
    pct[3].y = pp->y;
    line[1] = lv_line_create(lv_scr_act(), NULL);
    lv_line_set_style(line[1], &style1);
    lv_obj_set_pos(line[1], 0, 0);
    lv_line_set_points(line[1], &pct[2], 2);

    pct[4].x = pp->x;
    pct[4].y = pp->y - CALIBRATION_CROSS_RADIUS;
    pct[5].x = pp->x;
    pct[5].y = pp->y - CALIBRATION_CROSS_INNERGAP;
    line[2] = lv_line_create(lv_scr_act(), NULL);
    lv_line_set_style(line[2], &style1);
    lv_obj_set_pos(line[2], 0, 0);
    lv_line_set_points(line[2], &pct[4], 2);

    pct[6].x = pp->x;
    pct[6].y = pp->y + CALIBRATION_CROSS_INNERGAP;
    pct[7].x = pp->x;
    pct[7].y = pp->y + CALIBRATION_CROSS_RADIUS;
    line[3] = lv_line_create(lv_scr_act(), NULL);
    lv_line_set_style(line[3], &style1);
    lv_obj_set_pos(line[3], 0, 0);
    lv_line_set_points(line[3], &pct[6], 2);

    pct[8].x = pp->x - CALIBRATION_CROSS_RADIUS;
    pct[8].y = pp->y + CALIBRATION_CROSS_RADIUS;
    pct[9].x = pp->x - CALIBRATION_CROSS_RADIUS / 2;
    pct[9].y = pp->y + CALIBRATION_CROSS_RADIUS;
    line[4] = lv_line_create(lv_scr_act(), NULL);
    lv_line_set_style(line[4], &style1);
    lv_obj_set_pos(line[4], 0, 0);
    lv_line_set_points(line[4], &pct[8], 2);

    pct[10].x = pp->x - CALIBRATION_CROSS_RADIUS;
    pct[10].y = pp->y + CALIBRATION_CROSS_RADIUS / 2;
    pct[11].x = pp->x - CALIBRATION_CROSS_RADIUS;
    pct[11].y = pp->y + CALIBRATION_CROSS_RADIUS;
    line[5] = lv_line_create(lv_scr_act(), NULL);
    lv_line_set_style(line[5], &style1);
    lv_obj_set_pos(line[5], 0, 0);
    lv_line_set_points(line[5], &pct[10], 2);

    pct[12].x = pp->x - CALIBRATION_CROSS_RADIUS;
    pct[12].y = pp->y - CALIBRATION_CROSS_RADIUS;
    pct[13].x = pp->x - CALIBRATION_CROSS_RADIUS / 2;
    pct[13].y = pp->y - CALIBRATION_CROSS_RADIUS;
    line[6] = lv_line_create(lv_scr_act(), NULL);
    lv_line_set_style(line[6], &style1);
    lv_obj_set_pos(line[6], 0, 0);
    lv_line_set_points(line[6], &pct[12], 2);

    pct[14].x = pp->x - CALIBRATION_CROSS_RADIUS;
    pct[14].y = pp->y - CALIBRATION_CROSS_RADIUS / 2;
    pct[15].x = pp->x - CALIBRATION_CROSS_RADIUS;
    pct[15].y = pp->y - CALIBRATION_CROSS_RADIUS;
    line[7] = lv_line_create(lv_scr_act(), NULL);
    lv_line_set_style(line[7], &style1);
    lv_obj_set_pos(line[7], 0, 0);
    lv_line_set_points(line[7], &pct[14], 2);

    pct[16].x = pp->x + CALIBRATION_CROSS_RADIUS / 2;
    pct[16].y = pp->y + CALIBRATION_CROSS_RADIUS;
    pct[17].x = pp->x + CALIBRATION_CROSS_RADIUS;
    pct[17].y = pp->y + CALIBRATION_CROSS_RADIUS;
    line[8] = lv_line_create(lv_scr_act(), NULL);
    lv_line_set_style(line[8], &style1);
    lv_obj_set_pos(line[8], 0, 0);
    lv_line_set_points(line[8], &pct[16], 2);

    pct[18].x = pp->x + CALIBRATION_CROSS_RADIUS;
    pct[18].y = pp->y + CALIBRATION_CROSS_RADIUS / 2;
    pct[19].x = pp->x + CALIBRATION_CROSS_RADIUS;
    pct[19].y = pp->y + CALIBRATION_CROSS_RADIUS;
    line[9] = lv_line_create(lv_scr_act(), NULL);
    lv_line_set_style(line[9], &style1);
    lv_obj_set_pos(line[9], 0, 0);
    lv_line_set_points(line[9], &pct[18], 2);

    pct[20].x = pp->x + CALIBRATION_CROSS_RADIUS / 2;
    pct[20].y = pp->y - CALIBRATION_CROSS_RADIUS;
    pct[21].x = pp->x + CALIBRATION_CROSS_RADIUS;
    pct[21].y = pp->y - CALIBRATION_CROSS_RADIUS;
    line[10] = lv_line_create(lv_scr_act(), NULL);
    lv_line_set_style(line[10], &style1);
    lv_obj_set_pos(line[10], 0, 0);
    lv_line_set_points(line[10], &pct[20], 2);

    pct[22].x = pp->x + CALIBRATION_CROSS_RADIUS;
    pct[22].y = pp->y - CALIBRATION_CROSS_RADIUS;
    pct[23].x = pp->x + CALIBRATION_CROSS_RADIUS;
    pct[23].y = pp->y - CALIBRATION_CROSS_RADIUS / 2;
    line[11] = lv_line_create(lv_scr_act(), NULL);
    lv_line_set_style(line[11], &style1);
    lv_obj_set_pos(line[11], 0, 0);
    lv_line_set_points(line[11], &pct[22], 2);
}
